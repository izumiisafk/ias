...
<div class="main-content">
    ...
    <div class="page-header d-flex justify-content-between align-items-start">
        <div>
            ...
            <p>Class Scheduling System — Full Access</p>
        </div>
        ...
        <div class="row g-3">
            <div class="col-md-2">
                <a href="schedules.php" class="quick-link-card">
                    <i class="bi bi-calendar3"></i><span>Timetable</span>
                </a>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
                <a href="conflicts.php" class="quick-link-card <?= $conflicts_count > 0 ? 'has-alert' : '' ?>">
                    <i class="bi bi-exclamation-triangle-fill"></i>
                    <span>Conflicts<?= $conflicts_count > 0 ? ' ('.$conflicts_count.')' : '' ?></span>
                </a>
            </div>
            <div class="col-md-2">
                <a href="staff_management.php" class="quick-link-card">
                    <i class="bi bi-person-gear"></i><span>Staff</span>
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <div style="font-size:13px; color:var(--text-secondary); margin-top:3px;">
                    Review and fix overlapping schedules in the timetable.
                </div>
            </div>
            <a href="conflicts.php" class="btn-primary-custom ms-auto" style="white-space:nowrap;">
                <i class="bi bi-arrow-right-circle me-1"></i>Resolve Now
            </a>
        </div>
    </div>
    <?php endif; ?>

    <?php if ($overloaded_count > 0): ?>
    <!-- OVERLOAD ALERT BANNER -->
    <div class="content-card mt-3" style="border-left:4px solid #06b6d4; background:rgba(6,182,212,0.04);">
        <div class="d-flex align-items-center gap-3">
            <i class="bi bi-person-fill-exclamation" style="font-size:28px; color:#06b6d4; flex-shrink:0;"></i>
            <div>
                <div style="font-weight:700; color:#06b6d4; font-size:15px;">
                    <?= $overloaded_count ?> Faculty Member<?= $overloaded_count > 1 ? 's' : '' ?> Overloaded
                </div>
                <div style="font-size:13px; color:var(--text-secondary); margin-top:3px;">
                    Some faculty have exceeded their maximum teaching hours.
                </div>
            </div>
            <a href="faculty_load.php" class="btn-secondary-custom ms-auto" style="white-space:nowrap;">
                <i class="bi bi-eye me-1"></i>View Load
            </a>
        </div>
    </div>
    <?php endif; ?>
...
.quick-link-card {
    ...
    gap:10px; padding:20px 10px; border-radius:12px;
...
.quick-link-card.has-alert { border-color:rgba(239,68,68,0.4); background:rgba(239,68,68,0.06); }
.quick-link-card.has-alert i { color:#ef4444; }
.quick-link-card.has-alert span { color:#ef4444; }
